    ...
    if request.method == "GET":
        try:
            ...
            user_info = {
                ...
                "api_keys": {
                    "has_pinecone_api_key": True if user_keys and user_keys.get("pinecone_api_key") else False,
                    "has_gemini_api_key": True if user_keys and user_keys.get("gemini_api_key") else False,
                    "has_groq_api_key": True if user_keys and user_keys.get("groq_api_key") else False,
                    "has_mistral_api_key": True if user_keys and user_keys.get("mistral_api_key") else False,
                    "has_cohere_api_key": True if user_keys and user_keys.get("cohere_api_key") else False,
                    "has_jina_api_key": True if user_keys and user_keys.get("jina_api_key") else False,
                },
